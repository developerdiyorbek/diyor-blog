...
const AboutPage = async () => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <h1 className="text-4xl text-center font-creteRound">
        We are the Qurno, <br /> Team of writers and designers
      </h1>
      ...
      <div className="grid grid-cols-4 gap-4 min-h-96 mt-6">
        ...
        <div
          className="self-end h-80 relative max-md:col-span-2 max-md:h-72
        "
        >
          <Image
            fill
        ...
        <div
          className="h-80 relative max-md:col-span-2 max-md:mb-8 max-md:h-72
        "
        >
          <Image
            fill
